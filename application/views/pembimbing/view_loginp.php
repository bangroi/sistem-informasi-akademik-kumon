...
<html lang="en">
	...
	<body class="menubar-hoverable header-fixed ">
		...
		<section class="section-account">
			<div class="img-backdrop" style="background-image: url(<?php echo base_url().'assets/logo/logo-kumon.png'?>)"></div>
			...
			<div class="card contain-sm style-transparent">
				<div class="card-body">
					<div class="row">
						<div class="col-sm-6">
							<br/>
							<span class="text-lg text-bold text-primary">LOGIN PEMBIMBING</span>
							<br/><br/>
							<?php echo $this->session->flashdata('msg');?>
							 <?php echo form_open('c_pembimbing',['class'=>'form floating-label']);?>
							
								<div class="form-group">
									<input type="text" class="form-control" id="username" name="usernamep" required>
									<label for="username">Username</label>
								</div>
								<div class="form-group">
									<input type="password" class="form-control" id="password" name="passwordp" required>
