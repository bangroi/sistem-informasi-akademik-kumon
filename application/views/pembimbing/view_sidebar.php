			...
			<div id="menubar" class="menubar-inverse ">
				...
				<div class="menubar-scroll-panel">
					...
					<ul id="main-menu" class="gui-controls">
						...
						<!-- BEGIN DASHBOARD -->
						<li>
							<a href="<?php echo base_url().'c_pembimbing/dashboard'?>">
						...
						<li>
							<a href="<?php echo base_url().'c_pembimbing/dataSiswaPembimbing'?>">
						...
						<li>
							<a href="<?php echo base_url().'c_pembimbing/subyekBelajarPembimbing'?>">
								<div class="gui-icon"><i class="fa fa-book"></i></div>
								<span class="title">Subyek Belajar Siswa</span>
							</a>
						</li>
						<li>
							<a href="<?php echo base_url().'c_pembimbing/kemajuanBelajarPembimbing'?>">
								<div class="gui-icon"><i class="fa fa-line-chart"></i></div>
								<span class="title">Kemajuan Belajar</span>
							</a>
						</li>
						<li>
							<a href="<?php echo base_url().'c_pembimbing/bayarPembimbing'?>">
								<div class="gui-icon"><i class="fa fa-money"></i></div>
								<span class="title">Pembayaran</span>
							</a>
						</li>
						<li>
							<a href="<?php echo base_url().'c_pembimbing/dataWalimurid'?>">
								<div class="gui-icon"><i class="fa fa-users"></i></div>
						...
						<li>
							<a href="<?php echo base_url().'c_pembimbing/dataAdmin'?>">
								<div class="gui-icon"><i class="fa fa-user"></i></div>
								<span class="title">Data Admin</span>
							</a>
						</li>
						<li>
							<a href="<?=base_url('c_pembimbing/logout'); ?>">
