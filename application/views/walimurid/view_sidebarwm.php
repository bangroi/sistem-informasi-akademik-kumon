			...
			<div id="menubar" class="menubar-inverse ">
				...
				<div class="menubar-scroll-panel">
					...
					<ul id="main-menu" class="gui-controls">
						...
						<!-- BEGIN DASHBOARD -->
						<li>
							<a href="<?php echo base_url().'walimurid/dashboard'?>" class="active">
						...
						<!-- END DASHBOARD -->
						<li>
							<a href="<?php echo base_url().'walimurid/kemajuanBelajar'?>">
						...
						<li>
							<a href="<?php echo base_url().'walimurid/pembayaran'?>">
