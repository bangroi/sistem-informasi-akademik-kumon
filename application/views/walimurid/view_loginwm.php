			...
			<div class="card contain-sm style-transparent">
				<div class="card-body">
					<div class="row">
						<div class="col-sm-6">
							<br/>
							<span class="text-lg text-bold text-primary">LOGIN WALI MURID</span>
							<br/><br/>
							<?php echo $this->session->flashdata('msg');?>
							 <?php echo form_open('walimurid',['class'=>'form floating-label']);?>
							
								<div class="form-group">
									<input type="text" class="form-control" id="username" name="emailwm" required>
									<label for="username">Username</label>
								</div>
								<div class="form-group">
									<input type="password" class="form-control" id="password" name="passwordwm" required>
